...
（大小、数量、质量等）波动；（在…之间）起伏不定to change frequently in size, amount, quality, etc., especially from one extreme to another " }
...
~ (of sb/sth) (to sb/sth) （时间或空间）接近，邻近，靠近the state of being near sb/sth in distance or time       "    }
...
n.黏液；鼻涕；粘液；粘液丝；分泌物
黏液；鼻涕a thick liquid that is produced in parts of the body, such as the nose, by a mucous membrane "  }
...
adj.混杂的；各种各样的；杂项；其他；其它
混杂的；各种各样的consisting of many different kinds of things that are not connected and do not easily form a group  "  }
...
abridge(){ " 美 [əˈbrɪdʒd] 英 [əˈbrɪdʒd]
v.摘要；减少；节省；剥夺；删节的；缩略删减的；节略
abide美 [əˈbaɪd] 英 [əˈbaɪd] v.容忍；等候；逗留；居留；遵守；忍受；坚持
Besides, the business contact between the company and the bank shall abide by related rules of the bank.
另外，本公司与银行之间的业务往来，必须遵守银行的有关规定。                 " }
...
v.“mandate”的过去分词和过去式，[网络]委托管理的；委托统治的；强制  " }
